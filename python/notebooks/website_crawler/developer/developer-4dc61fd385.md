...
# PATCH /configuration\_interfaces/:id
...
| **data[attributes][configuration\_type\_id]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][configuration\_status\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][location\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][contact\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][manufacturer\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
...
| **data[\_][attributes][contact\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âcontactsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `contacts`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][contact\_type\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[\_][attributes][location\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[\_][attributes][first\_name]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][last\_name]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][title]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][important]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
...
# DELETE /organizations/:organization\_id/relationships/contacts
...
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[name]**    optional | exact match only  **Validations:**   * Must be a String |
| **filter[iso]**    optional | **Validations:**   * Must be a String |
| **sort**    optional | **Validations:**   * Must be one of: `name`, `id`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
...
Example: /configurations/1?include=related\_items

# POST /:resource\_type/:resource\_id/relationships/related\_items
...
The create action is directional from source item to destination item(s). The source item is the item that matches the `resource_type` and `resource_id` in the URL. The destination item(s) are the items that match the `destination_type` and `destination_id` in the JSON object.
...
| Param name | Description |
| --- | --- |
| **resource\_type**    required | The resource type of the parent resource  **Validations:**   * Must be one of: `checklists`, `checklist_templates`, `configurations`, `contacts`, `documents`, `domains`, `folders`, `locations`, `passwords`, `ssl_certificates`, `flexible_assets`, `tickets`.  Metadata:  ``` Param Type: In URL ``` |
| **resource\_id**    required | The resource id of the parent resource.  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `related_items`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    required | **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **data[attributes][destination\_type]**    required | **Validations:**   * Must be one of: `User`, `Checklist`, `Checklist Template`, `Contact`, `Configuration`, `Datto Device`, `Document`, `Document Folder`, `Domain`, `Location`, `Organization`, `Password`, `SSL Certificate`, `Flexible Asset`, `Ticket`. |
| **data[attributes][destination\_id]**    required | **Validations:**   * Must be a String |
| **data[attributes][notes]**    optional | **Validations:**   * Must be a String |
| **data[attributes][via\_copilot]**    optional | **Validations:**   * Must be a String |

# PATCH /:resource\_type/:resource\_id/relationships/related\_items/:id
...
# DELETE /:resource\_type/:resource\_id/relationships/related\_items
...
| **resource\_id**    required | The resource id of the parent resource.  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param Notes: Cannot be used in combination with filter ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: ârelated\_itemsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `related_items`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    required | **Validations:**   * Must be a number. |
...
# PATCH /organizations/:organization\_id/relationships/documents/:id
...
| **organization\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` :Param Type: In URL :Notes: Must be a valid Organization Id in your Account ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `documents`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][organization\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][public]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][is\_uploaded]**    optional , nil allowed | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][document\_folder\_id]**    optional , nil allowed | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be a number. |
| **data[attributes][sop\_generator]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
...
| **organization\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` :Param Type: In URL :Notes: Must be a valid Organization Id in your Account ``` |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` :Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âdocumentsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `documents`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][public]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][is\_uploaded]**    optional , nil allowed | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][document\_folder\_id]**    optional , nil allowed | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be a number. |
| **data[\_][attributes][sop\_generator]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
...
# GET /organizations/:organization\_id/relationships/domains
...
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `passwords`, `attachments`, `user_resource_accesses`, `group_resource_accesses`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
...
# GET /organizations/:organization\_id/relationships/expirations
...
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[resource\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[resource\_name]**    optional | **Validations:**   * Must be a String |
| **filter[resource\_type\_name]**    optional | **Validations:**   * Must be a String |
| **filter[description]**    optional | **Validations:**   * Must be a String |
| **filter[expiration\_date]**    optional | **Validations:**   * Must be a String |
| **filter[organization\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[range]**    optional | To filter on a specific range, supply two comma-separated values (e.g. â2, 10â is filtering for all that are greater than or equal to 2 and less than or equal to 10). Or, an asterisk ( \* ) can filter on values either greater than or equal to (e.g. â2, \*â), or less than or equal to (â\*, 10â)  **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **filter[range][expiration\_date]**    optional | **Validations:**   * Must be a String |
| **sort**    optional | **Validations:**   * Must be one of: `id`, `organization_id`, `expiration_date`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
...
# GET /organizations/:organization\_id/relationships/expirations/:id
...
| --- | --- |
| **id**    required | **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **include**    optional | **Validations:**   * Must be one of: .  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# POST /exports

Create a exports.

Creates a new export under the current account. The new export will be for a single organization if organization\_id is specified; otherwise The new export will be for all organizations of the current account. Returns the created export record if successful.
...
| Param name | Description |
| --- | --- |
| **type**    required | **Validations:**   * Must be one of: `exports`. |
| **attributes**    required | **Validations:**   * Must be a Hash |
| **attributes[organization\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **attributes[include\_logs]**    optional , nil allowed | Defaults to false if not provided  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **attributes[zip\_password]**    optional , nil allowed | **Validations:**   * Must be a String |
...
To explore the different fields that are available, refer to our [Flexible asset field definitions](https://help.itglue.kaseya.com/help/Content/2-using/flexible-assets/flexible-asset-field-definitions.html) article.

# GET /flexible\_asset\_types/:flexible\_asset\_type\_id/relationships/flexible\_asset\_fields
...
| Param name | Description |
| --- | --- |
| **flexible\_asset\_type\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL :Notes: Must be a valid Flexible asset type Id in your Account ``` |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **sort**    optional | **Validations:**   * Must be one of: `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `remote_asset_field`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# GET /flexible\_asset\_fields/:id

Retrieve a flexible asset field.

# GET /flexible\_asset\_types/:flexible\_asset\_type\_id/relationships/flexible\_asset\_fields/:id
...
# POST /flexible\_asset\_fields

Create a flexible asset field.

# POST /flexible\_asset\_types/:flexible\_asset\_type\_id/relationships/flexible\_asset\_fields
...
| **flexible\_asset\_type\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL :Notes: Must be a valid Flexible asset type Id in your Account ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `flexible_asset_fields`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for updates  **Validations:**   * Must be a number. |
| **data[attributes][flexible\_asset\_type\_id]**    required | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][order]**    required | **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][kind]**    required | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[attributes][hint]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][decimals]**    optional , nil allowed | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[attributes][default\_value]**    optional , nil allowed | Required if field type is Select  **Validations:**   * Must be a String |
| **data[attributes][tag\_type]**    optional , nil allowed | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
| **data[attributes][required]**    optional , nil allowed | Indicates if the field is required for the flexible asset; it will be set to false if the field type is Header  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][use\_for\_title]**    optional , nil allowed | Indicates if the field name should be added to the flexible asset name; it will be set to false if the field type is one of: Checkbox, Header, Number, Password, Percent, Step, Tag, Textbox, Upload  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][expiration]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][show\_in\_list]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |

# PATCH /flexible\_asset\_fields/:id

Update a flexible asset field.

# PATCH /flexible\_asset\_types/:flexible\_asset\_type\_id/relationships/flexible\_asset\_fields/:id
...
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for updates  **Validations:**   * Must be a number. |
| **data[attributes][flexible\_asset\_type\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][order]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[attributes][kind]**    optional | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[attributes][hint]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][decimals]**    optional , nil allowed | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[attributes][default\_value]**    optional , nil allowed | Required if field type is Select  **Validations:**   * Must be a String |
| **data[attributes][tag\_type]**    optional , nil allowed | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âflexible\_asset\_fieldsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `flexible_asset_fields`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][flexible\_asset\_type\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][order]**    optional | **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][kind]**    optional | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[\_][attributes][hint]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][decimals]**    optional , nil allowed | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[\_][attributes][default\_value]**    optional , nil allowed | Required if field type is Select  **Validations:**   * Must be a String |
| **data[\_][attributes][tag\_type]**    optional , nil allowed | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
| **data[\_][attributes][required]**    optional , nil allowed | Indicates if the field is required for the flexible asset; it will be set to false if the field type is Header  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][use\_for\_title]**    optional , nil allowed | Indicates if the field name should be added to the flexible asset name; it will be set to false if the field type is one of: Checkbox, Header, Number, Password, Percent, Step, Tag, Textbox, Upload  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][expiration]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][show\_in\_list]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |

# DELETE /flexible\_asset\_fields/:id

Delete a flexible asset field.

# DELETE /flexible\_asset\_types/:flexible\_asset\_type\_id/relationships/flexible\_asset\_fields/:id
...
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[icon]**    optional | **Validations:**   * Must be a String |
| **filter[enabled]**    optional | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **sort**    optional | **Validations:**   * Must be one of: `id`, `name`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `flexible_asset_fields`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# GET /flexible\_asset\_types/:id

Retrieve a flexible asset type.

Returns the details of an existing flexible asset type.

The following example demonstrates a return value for a request with the `flexible_asset_fields` parameter included :
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `flexible_asset_types`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][description]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][icon]**    optional , nil allowed | icon image name  **Validations:**   * Must be a String |
| **data[attributes][enabled]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][fields]**    required | List of fields for this flexible asset type; each flexible asset type must have at least one field and at least one field with show\_in\_list set to true  **Validations:**   * Must be an Array of nested elements |
| **data[attributes][fields][id]**    optional , nil allowed | Required identifier for updates  **Validations:**   * Must be a number. |
| **data[attributes][fields][flexible\_asset\_type\_id]**    required | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][fields][order]**    required | **Validations:**   * Must be a number. |
| **data[attributes][fields][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][fields][kind]**    required | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[attributes][fields][hint]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][fields][decimals]**    optional , nil allowed | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[attributes][fields][default\_value]**    optional , nil allowed | Required if field type is Select  **Validations:**   * Must be a String |
| **data[attributes][fields][tag\_type]**    optional , nil allowed | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
| **data[attributes][fields][required]**    optional , nil allowed | Indicates if the field is required for the flexible asset; it will be set to false if the field type is Header  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][fields][use\_for\_title]**    optional , nil allowed | Indicates if the field name should be added to the flexible asset name; it will be set to false if the field type is one of: Checkbox, Header, Number, Password, Percent, Step, Tag, Textbox, Upload  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][fields][expiration]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][fields][show\_in\_list]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[relationships]**    optional | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be a Hash |
| **data[relationships][flexible\_asset\_fields]**    optional | **Validations:**   * Must be a Hash |
| **data[relationships][flexible\_asset\_fields][data]**    optional | Can contain multiple Flexible Asset Fields  **Validations:**   * Must be an Array of nested elements |
| **data[relationships][flexible\_asset\_fields][data][\_]**    optional | Nameless hash: should look like: {âtypeâ: âflexible\_asset\_fieldsâ, âattributesâ.â¦}  **Validations:**   * Must be a Hash |
| **data[relationships][flexible\_asset\_fields][data][\_][type]**    required | **Validations:**   * Must be one of: `flexible_asset_fields`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes]**    optional | **Validations:**   * Must be a Hash |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][order]**    required | **Validations:**   * Must be a number. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][name]**    required | **Validations:**   * Must be a String |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][kind]**    required | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][hint]**    optional | **Validations:**   * Must be a String |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][decimals]**    optional | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][default\_value]**    optional | Required if field type is Select  **Validations:**   * Must be a String |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][tag\_type]**    optional | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][required]**    optional | Indicates if the field is required for the flexible asset; it will be set to false if the field type is Header  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][use\_for\_title]**    optional | Indicates if the field name should be added to the flexible asset name; it will be set to false if the field type is one of: Checkbox, Header, Number, Password, Percent, Step, Tag, Textbox, Upload  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][expiration]**    optional | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[relationships][flexible\_asset\_fields][data][\_][attributes][show\_in\_list]**    optional | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |

# PATCH /flexible\_asset\_types/:id
...
| **data[attributes][fields]**    required | List of fields for this flexible asset type; each flexible asset type must have at least one field and at least one field with show\_in\_list set to true  **Validations:**   * Must be an Array of nested elements |
| **data[attributes][fields][id]**    optional , nil allowed | Required identifier for updates  **Validations:**   * Must be a number. |
| **data[attributes][fields][flexible\_asset\_type\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][fields][order]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][fields][name]**    optional | **Validations:**   * Must be a String |
| **data[attributes][fields][kind]**    optional | Kind cannot be changed once there are traits created for the field  **Validations:**   * Must be one of: `Checkbox`, `Date`, `Header`, `Number`, `Select`, `Text`, `Textbox`, `Upload`, `Tag`, `Percent`, `Password`. |
| **data[attributes][fields][hint]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][fields][decimals]**    optional , nil allowed | A non-negative required value if field type is Number or Percent  **Validations:**   * Must be a number. |
| **data[attributes][fields][default\_value]**    optional , nil allowed | Required if field type is Select  **Validations:**   * Must be a String |
| **data[attributes][fields][tag\_type]**    optional , nil allowed | **Validations:**   * Must be one of: `AccountsUsers`, `Checklists`, `ChecklistTemplates`, `Contacts`, `Configurations`, `Documents`, `Domains`, `Passwords`, `Locations`, `Organizations`, `SslCertificates`, `Tickets`, `FlexibleAssetType: id`. |
...
Every flexible asset (record) has a set of traits. Each trait is a JSON key-value pair. The key part of the key-value pair is the `name-key` for the corresponding flexible asset field. The value part is the field data. For example, if you have a key called `ip-address`, then you would enter an actual IP address as its value.

Note: The `use-for-title` property of fields in the flexible asset type is what determines the name of each associated flexible asset. If more than one field has the `use-for-title` property set to true, the text strings are joined into one string.

# GET /flexible\_assets
...
| Param name | Description |
| --- | --- |
| **filter**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Description: All filter params have to be exact match only ``` |
| **filter[flexible-asset-type-id]**    required | **Validations:**   * Must be a number. |
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[organization-id]**    optional | **Validations:**   * Must be a number. |
| **sort**    optional | **Validations:**   * Must be one of: `name`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `adapters_resources`, `distinct_remote_assets`, `attachments`, `passwords`, `user_resource_accesses`, `group_resource_accesses`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# GET /flexible\_assets/:id

Retrieve a flexible asset.

Returns the details of an existing flexible asset.

The following example demonstrates a return value for a request with the `attachments` parameter included:
...
| --- | --- |
| **id**    required | **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **include**    optional | **Validations:**   * Must be one of: `adapters_resources`, `distinct_remote_assets`, `attachments`, `passwords`, `user_resource_accesses`, `group_resource_accesses`, `recent_versions`, `related_items`, `authorized_users`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# POST /flexible\_assets

Create a flexible asset.

# POST /organizations/:organization\_id/relationships/flexible\_assets
...
Files can be encoded and passed in JSON format for direct upload to a flexible asset with an Upload field. The file has to be strict encoded. You need to convert it using something like [www.freeformatter.com/base64-encoder.html](https://www.freeformatter.com/base64-encoder.html). This produces a string of text that goes into the `content` field. For example:
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `flexible_assets`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][organization\_id]**    required | **Validations:**   * Must be a number. |
| **data[attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][flexible\_asset\_type\_id]**    required | **Validations:**   * Must be a number. |
| **data[attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][traits]**    required | A hash of key value pairs for the traits of this asset. Values can be arrays. The key has to be an available field key from the specified flexible asset type.  **Validations:**   * Must be a Hash |

# PATCH /flexible\_assets/:id
...
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][organization\_id]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][traits]**    optional | A hash of key value pairs for the traits of this asset. Values can be arrays. The key has to be an available field key from the specified flexible asset type.  **Validations:**   * Must be a Hash |

# PATCH /flexible\_assets
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âflexible\_assetsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `flexible_assets`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_id]**    optional | **Validations:**   * Must be a number. |
| **data[\_][attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][traits]**    optional | A hash of key value pairs for the traits of this asset. Values can be arrays. The key has to be an available field key from the specified flexible asset type.  **Validations:**   * Must be a Hash |

# DELETE /flexible\_assets/:id
...
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[name]**    optional | exact match only  **Validations:**   * Must be a String |
| **filter[organization\_id]**    required | **Validations:**   * Must be a number. |
| **filter[flexible\_asset\_type\_id]**    required | **Validations:**   * Must be a number. |
| **filter[archived]**    optional | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
...
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `users`, `organizations`, `resource_type_restrictions`, `my_glue_account`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
  ...
  Response:
{
    "data": {
        ...
        "attributes": {
            "name": "my group",
            "created-at": "2025-04-16T15:34:28.000Z",
            "updated-at": "2025-04-16T15:34:28.000Z",
            "description": null,
            "my-glue": true,
            "my-glue-account-id": 1688,
            "hide-from-my-glue": false
        },
        "relationships": {
            "my-glue-account": {
                "data": {
                    "id": "1688",
                    "type": "my_glue_account"
                }
            },
            "organizations": {
                "data": [
...
| Param name | Description |
| --- | --- |
| **type**    required | **Validations:**   * Must be one of: `groups`. |
| **attributes**    required | **Validations:**   * Must be a Hash |
| **attributes[id]**    optional , nil allowed | Unique identifier for the group bulk update  **Validations:**   * Must be a number. |
| **attributes[name]**    required | Name of the group  **Validations:**   * Must be a String |
| **attributes[description]**    optional , nil allowed | Description of the group  **Validations:**   * Must be a String |
| **attributes[hide\_from\_my\_glue]**    optional , nil allowed | Hide this group from my glue  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **attributes[accounts\_user\_ids]**    optional , nil allowed | Array of account user ids  **Validations:**   * Must be an array of any type  Metadata:  ``` :notes: accounts_user_ids HAS to include all the users that are in the group. You   get the users in the group by adding ?include=users to the GET groups/:id request.   If you want to remove all users from the group, you can send an empty array. If   you want to remove one user, send the all user ids without the user id you want   to remove. If you want to add a user, send the all user ids with the user id you   want to add. ``` |
  ...
  Response:
{
    "data": {
        ...
        "attributes": {
            "name": "ITGlue",
            "created-at": "2022-10-06T18:39:51.000Z",
            "updated-at": "2025-01-17T21:14:45.000Z",
            "description": "",
            "my-glue": true,
            "my-glue-account-id": 1,
            "hide-from-my-glue": false
        },
        "relationships": {}
    }
...
| **attributes**    required | **Validations:**   * Must be a Hash |
| **attributes[id]**    optional , nil allowed | Unique identifier for the group bulk update  **Validations:**   * Must be a number. |
| **attributes[name]**    optional | Name of the group  **Validations:**   * Must be a String |
| **attributes[description]**    optional , nil allowed | Description of the group  **Validations:**   * Must be a String |
| **attributes[hide\_from\_my\_glue]**    optional , nil allowed | Hide this group from my glue  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **attributes[accounts\_user\_ids]**    optional , nil allowed | Array of account user ids  **Validations:**   * Must be an array of any type  Metadata:  ``` :notes: accounts_user_ids HAS to include all the users that are in the group. You   get the users in the group by adding ?include=users to the GET groups/:id request.   If you want to remove all users from the group, you can send an empty array. If   you want to remove one user, send the all user ids without the user id you want   to remove. If you want to add a user, send the all user ids with the user id you   want to add. ``` |
...
Updates a list of groups in bulk. The bulk update PATCH format is similar to the response from a GET on a list resource. It accepts a partial representation of each groupâonly the attributes you provide will be updated; all others remain unchanged.
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `groups`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Unique identifier for the group bulk update  **Validations:**   * Must be a number. |
| **data[attributes][name]**    optional | Name of the group  **Validations:**   * Must be a String |
| **data[attributes][description]**    optional , nil allowed | Description of the group  **Validations:**   * Must be a String |
| **data[attributes][hide\_from\_my\_glue]**    optional , nil allowed | Hide this group from my glue  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[name]**    optional | **Validations:**   * Must be a String |
...
# GET /organizations/:organization\_id/relationships/locations
...
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[city]**    optional | **Validations:**   * Must be a String |
| **filter[region\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[country\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[organization\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[psa\_id]**    optional | **Validations:**   * Must be a String  Metadata:  ``` Notes: This must be accompanied by the filter for psa_integration_type ``` |
| **filter[psa\_integration\_type]**    optional | **Validations:**   * Must be one of: `manage`, `autotask`, `tigerpaw`, `kaseya-bms`, `pulseway-psa`, `vorex`. |
| **sort**    optional | **Validations:**   * Must be one of: `name`, `id`, `primary`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `adapters_resources`, `attachments`, `passwords`, `user_resource_accesses`, `group_resource_accesses`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# GET /locations/:id

Retrieve a location.

# GET /organizations/:organization\_id/relationships/locations/:id
...
| **organization\_id**    required | Only required for nested relationships route.  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL Notes: Must be a valid organization ID in your account. ``` |
| **id**    required | **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **include**    optional | **Validations:**   * Must be one of: `adapters_resources`, `attachments`, `passwords`, `user_resource_accesses`, `group_resource_accesses`, `recent_versions`, `related_items`, `authorized_users`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# POST /locations

Create a location

# POST /organizations/:organization\_id/relationships/locations

Create a location for a particular organization.

Creates a new location under the specified organization. The :organization\_id is specified in the URL or in the request body for `/locations` route. Returns a 201 status on success; the created object is returned the response body.
...
| **organization\_id**    required | Only required for nested relationships route.  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL Notes: Must be a valid organization ID in your account. ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `locations`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][organization\_id]**    required | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][primary]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][address\_1]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][address\_2]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][city]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][postal\_code]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][region\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][country\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][phone]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][fax]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
...
# PATCH /organizations/:organization\_id/relationships/locations/:id
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âlocationsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `locations`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][primary]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][address\_1]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][address\_2]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][city]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][postal\_code]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][region\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[\_][attributes][country\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[\_][attributes][phone]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][fax]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
...
# DELETE /organizations/:organization\_id/relationships/locations/:id
...
**IMPORTANT NOTE:** This endpoint is limited to **5** pages of results. If more results are desired, setting a larger page [size] will increase the number of results per page. To iterate over even more results, use filter [created\_at] (with created\_at sort) to fetch a subset of results based on timestamp, then use the last timestamp in the last page the start date in the filter for the next request.
...
| --- | --- |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[created\_at]**    optional | The specified string must be a date range and comma-separated as `start\_date, end\_date`. The dates are UTC. Use `\*` for unspecified `start\_date` or `end\_date`. Date ranges longer than a week may be disallowed for performance reasons.  **Validations:**   * Must be a String |
| **sort**    optional | **Validations:**   * Must be one of: `created_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number.  Metadata:  ``` Notes: Must be a value between 1 and 5 (inclusive). ``` |
| **page[size]**    optional | **Validations:**   * Must be a number. |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `manufacturers`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
...
# GET /manufacturers/:manufacturer\_id/relationships/models
...
| Param name | Description |
| --- | --- |
| **manufacturer\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL :Notes: Must be a valid Manufacturer Id in your Account ``` |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **sort**    optional | **Validations:**   * Must be one of: `id`, `name`, `manufacturer_id`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
...
# GET /manufacturers/:manufacturer\_id/relationships/models/:id
...
# POST /manufacturers/:manufacturer\_id/relationships/models
...
| **manufacturer\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL :Notes: Must be a valid Manufacturer Id in your Account ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `models`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][manufacturer\_id]**    optional , nil allowed | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
...
# PATCH /manufacturers/:manufacturer\_id/relationships/models/:id
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âmodelsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `models`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][manufacturer\_id]**    optional , nil allowed | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `organization_statuses`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |

# PATCH /organization\_statuses/:id
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `organization_types`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |

# PATCH /organization\_types/:id
...
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[organization\_type\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[organization\_status\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[created\_at]**    optional | The specified string must be a date range and comma-separated as `start\_date, end\_date`. The dates are UTC. Use `\*` for unspecified `start\_date` or `end\_date`. Date ranges longer than a week may be disallowed for performance reasons.  **Validations:**   * Must be a String |
| **filter[updated\_at]**    optional | The specified string must be a date range and comma-separated as `start\_date, end\_date`. The dates are UTC. Use `\*` for unspecified `start\_date` or `end\_date`. Date ranges longer than a week may be disallowed for performance reasons.  **Validations:**   * Must be a String |
| **filter[my\_glue\_account\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[psa\_id]**    optional | **Validations:**   * Must be a String  Metadata:  ``` Notes: This must be accompanied by the filter for psa_integration_type ``` |
| **filter[psa\_integration\_type]**    optional | **Validations:**   * Must be one of: `manage`, `autotask`, `tigerpaw`, `kaseya-bms`, `pulseway-psa`, `vorex`. |
| **filter[group\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[primary]**    optional | **Validations:**   * Must be a String |
| **filter[exclude]**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[exclude][id]**    optional | **Validations:**   * Must be a number. |
| **filter[exclude][name]**    optional | **Validations:**   * Must be a String |
| **filter[exclude][organization\_type\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[exclude][organization\_status\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[range]**    optional | To filter on a specific range, supply two comma-separated values (e.g. â2, 10â is filtering for all that are greater than or equal to 2 and less than or equal to 10). Or, an asterisk ( \* ) can filter on values either greater than or equal to (e.g. â2, \*â), or less than or equal to (â\*, 10â)  **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **filter[range][my\_glue\_account\_id]**    optional | **Validations:**   * Must be a number. |
| **sort**    optional | **Validations:**   * Must be one of: `name`, `id`, `updated_at`, `organization_status_name`, `organization_type_name`, `created_at`, `short_name`, `my_glue_account_id`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `adapters_resources`, `attachments`, `rmm_companies`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `organizations`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][alert]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][description]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][organization\_type\_id]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][organization\_status\_id]**    optional | **Validations:**   * Must be a number. |
| **data[attributes][quick\_notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][short\_name]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][parent\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |

# PATCH /organizations/:id

Update an organization.

Updates the details of an existing organization. Returns 422 Bad Request error if trying to update an externally synced record on attributes other than: alert, description, quick\_notes
...
Updates a list of organizations, also known as bulk updating. Bulk updates using a nested relationships route are not supported. Returns 422 Bad Request error if trying to update an externally synced record on attributes other than: alert, description, quick\_notes
...
| Param name | Description |
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param Notes: Must be a hash if used with filter ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âorganizationsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `organizations`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][alert]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][description]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][organization\_type\_id]**    optional | **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_status\_id]**    optional | **Validations:**   * Must be a number. |
| **data[\_][attributes][quick\_notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][short\_name]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][parent\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[id]**    optional | **Validations:**   * Must be a number. |
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[organization\_type\_id]**    optional | **Validations:**   * Must be a number. |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `password_categories`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |

# PATCH /password\_categories/:id
...
For added security, accessing the actual password values is an optional setting that must be explicitly enabled for each API key. To enable this setting, select the âPassword Accessâ checkbox under Account > Settings > API Keys. Once enabled, password values can be sent and received over HTTPS.

# GET /passwords

List all passwords in your account.

# GET /organizations/:organization\_id/relationships/passwords
...
| **filter[name]**    optional | **Validations:**   * Must be a String |
| **filter[organization\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[password\_category\_id]**    optional | **Validations:**   * Must be a number. |
| **filter[url]**    optional | **Validations:**   * Must be a String |
| **filter[cached\_resource\_name]**    optional | **Validations:**   * Must be a String |
| **filter[archived]**    optional | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **sort**    optional | **Validations:**   * Must be one of: `name`, `username`, `url`, `id`, `created_at`, `updated_at`.  Metadata:  ``` Param Type: CGI Notes: |   To Invert order use -, eg: -name   Comma separated values ``` |
| **page**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI ``` |
| **page[number]**    optional | **Validations:**   * Must be a number. |
| **page[size]**    optional | **Validations:**   * Must be a number. |
| **include**    optional | **Validations:**   * Must be one of: `network_glue_networks`, `attachments`, `rotatable_password`, `updater`, `shared_links`, `active_shared_links`, `user_resource_accesses`, `group_resource_accesses`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |

# GET /passwords/:id

Retrieve a password.

# GET /organizations/:organization\_id/relationships/passwords/:id
...
| **organization\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL Notes: Must be a valid Organization Id in your Account ``` |
| **id**    required | **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |
| **include**    optional | **Validations:**   * Must be one of: `network_glue_networks`, `attachments`, `rotatable_password`, `updater`, `shared_links`, `active_shared_links`, `user_resource_accesses`, `group_resource_accesses`, `recent_versions`, `related_items`, `authorized_users`.  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **show\_password**    optional | defaults to 'true', Can be set to 'false' to not return the password  **Validations:**   * Must be one of: `true`, `false`.  Metadata:  ``` Param Type: In URL ``` |
| **version\_id**    optional | Set the password's version ID to return it's revision  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL ``` |

# POST /passwords

Create a password.

# POST /organizations/:organization\_id/relationships/passwords
...
Keep in mind that you can create general and embedded passwords with this endpoint: If the `resource-id` and `resource-type` attributes are NOT provided, IT Glue assumes the password is a general password. If the `resource-id` and `resource-type` attributes are provided, IT Glue assumes the password is an embedded password. Learn more about the difference between general and embedded passwords in [this article](https://help.itglue.kaseya.com/help/Content/2-using/security/choosing-between-general-and-embedded-passwords.html).
...
| --- | --- |
| **organization\_id**    required | Only required for nested relationships route  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL Notes: Must be a valid Organization Id in your Account ``` |
| **show\_password**    optional | defaults to 'false', Can be set to 'true' to return the password  **Validations:**   * Must be one of: `true`, `false`.  Metadata:  ``` Param Type: In URL ``` |
| **data**    required | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[type]**    required | **Validations:**   * Must be one of: `passwords`. |
| **data[attributes]**    required | **Validations:**   * Must be a Hash |
| **data[attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[attributes][organization\_id]**    required | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[attributes][password\_category\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[attributes][name]**    required | **Validations:**   * Must be a String |
| **data[attributes][username]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][password]**    required | **Validations:**   * Must be a String |
| **data[attributes][otp\_secret]**    optional , nil allowed | One Time Password secret  **Validations:**   * Must be a String |
| **data[attributes][resource\_id]**    optional , nil allowed | Must be used together with `resource\_type`  **Validations:**   * Must be a number. |
| **data[attributes][resource\_type]**    optional , nil allowed | Must be used together with `resource\_id`  **Validations:**   * Must be one of: `Configuration`, `Contact`, `Document`, `Domain`, `Location`, `SSL Certificate`, `Flexible Asset`, `Ticket`. |
| **data[attributes][url]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][password\_updated\_at]**    optional , nil allowed | Date the password last changed  **Validations:**   * Must be a String |
| **data[attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][autofill\_selectors]**    optional , nil allowed | Used for identification of fields for password autofill  **Validations:**   * Must be a String |
| **data[attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][is\_live]**    optional , nil allowed | Used for understanding - is this a live version of the password or not.  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[attributes][generated\_password\_type]**    optional , nil allowed | This value indicates if the user is using the complex password feature, and if the password is complex or pronounceable.  **Validations:**   * Must be a String |
| **data[attributes][shareable]**    optional , nil allowed | Indicates if password is can be shared with Secure Password Sharing feature.  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[relationships]**    optional | Not permitted in PUT/PATCH, optional in POST  **Validations:**   * Must be a Hash |
| **data[relationships][password\_category]**    optional | Can belong to one password category  **Validations:**   * Must be a Hash |
| **data[relationships][password\_category][data]**    optional | **Validations:**   * Must be a Hash |
| **data[relationships][password\_category][data][type]**    required | **Validations:**   * Must be one of: `password-categories`. |
| **data[relationships][password\_category][data][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[relationships][password\_category][data][attributes][name]**    required | **Validations:**   * Must be a String |
| **data[relationships][password\_category][data][attributes][account\_id]**    required | Identifies the account that this category belongs to.  **Validations:**   * Must be a number. |

# PATCH /passwords/:id

Update a password.

# PATCH /organizations/:organization\_id/relationships/passwords/:id
...
| **data[attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[attributes][username]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][password]**    optional | **Validations:**   * Must be a String |
| **data[attributes][otp\_secret]**    optional , nil allowed | One Time Password secret  **Validations:**   * Must be a String |
| **data[attributes][url]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[attributes][password\_updated\_at]**    optional , nil allowed | Date the password last changed  **Validations:**   * Must be a String |
...
| --- | --- |
| **data**    required | **Validations:**   * Must be an Array of nested elements  Metadata:  ``` Param Type: JSON Body Param ``` |
| **data[\_]**    optional | Nameless hash: should look like: {âtypeâ: âpasswordsâ, âattributesâ:â¦}  **Validations:**   * Must be a Hash |
| **data[\_][type]**    required | **Validations:**   * Must be one of: `passwords`. |
| **data[\_][attributes]**    required | **Validations:**   * Must be a Hash |
| **data[\_][attributes][id]**    optional , nil allowed | Required identifier for bulk updates  **Validations:**   * Must be a number. |
| **data[\_][attributes][organization\_id]**    optional | Not required when using nested relationship routes  **Validations:**   * Must be a number. |
| **data[\_][attributes][password\_category\_id]**    optional , nil allowed | **Validations:**   * Must be a number. |
| **data[\_][attributes][name]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][username]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][password]**    optional | **Validations:**   * Must be a String |
| **data[\_][attributes][otp\_secret]**    optional , nil allowed | One Time Password secret  **Validations:**   * Must be a String |
| **data[\_][attributes][url]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][notes]**    optional , nil allowed | **Validations:**   * Must be a String |
| **data[\_][attributes][password\_updated\_at]**    optional , nil allowed | Date the password last changed  **Validations:**   * Must be a String |
| **data[\_][attributes][restricted]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][autofill\_selectors]**    optional , nil allowed | Used for identification of fields for password autofill  **Validations:**   * Must be a String |
| **data[\_][attributes][archived]**    optional , nil allowed | **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][is\_live]**    optional , nil allowed | Used for understanding - is this a live version of the password or not.  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |
| **data[\_][attributes][generated\_password\_type]**    optional , nil allowed | This value indicates if the user is using the complex password feature, and if the password is complex or pronounceable.  **Validations:**   * Must be a String |
| **data[\_][attributes][shareable]**    optional , nil allowed | Indicates if password is can be shared with Secure Password Sharing feature.  **Validations:**   * Must be one of: `true`, `false`, `1`, `0`. |

# DELETE /passwords

Delete multiple passwords.

# DELETE /organizations/:organization\_id/relationships/passwords/:id
...
# GET /countries/:country\_id/relationships/regions
...
| Param name | Description |
| --- | --- |
| **country\_id**    required | Only required for nested relationships route.  **Validations:**   * Must be a number.  Metadata:  ``` Param Type: In URL :Notes: Must be a valid country ID. ``` |
| **filter**    optional | **Validations:**   * Must be a Hash  Metadata:  ``` Param Type: CGI Notes: Comma separated values ``` |
| **filter[name]**    optional | exact match only  **Validations:**   * Must be a String |
| **filter[iso]**    optional | **Validations:**   * Must be a String |
| **filter[country\_id]**    optional | **Validations:**   * Must be a number. |
...
# GET /countries/:country\_id/relationships/regions/:id
